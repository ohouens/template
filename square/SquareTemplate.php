...
class SquareTemplate extends Base{
    ...
    public function footer(Html $banner){
        ...
        <footer>
            <p id="copyright"><span>© ohouens 2021</span></p>
        	<div id="banner">
        	...
        	<div id="links">
        		<p class="center">
        			<a href="https://onisowo.com/policy/sale/">Sale policy</a>
        			<a href="https://onisowo.com/policy/terms/">Terms of use</a>
        			<a href="https://onisowo.com/policy/privacy/">Privacy policy</a>
        		</p>
        	</div>
        </footer>
        <?php
